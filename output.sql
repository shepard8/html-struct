...
-- Where <a href="#phrasing-content-1">phrasing content</a> is expected.
INSERT INTO element_context_child_no_attr (elt_name, cna_parent, att_name) VALUES ('the-col-element', 'the-colgroup-element', 'attr-col-span');
-- As a child of a <code><a href="#the-colgroup-element">colgroup</a></code> element that doesn't have a <code data-anolis-xref="attr-col-span"><a href="#attr-col-span">span</a></code> attribute.
...
-- Where <a href="#phrasing-content-1">phrasing content</a> is expected.
INSERT INTO element_context_between (elt_name, ecb_parent, ecb_before, ecb_after) VALUES ('the-dd-element', 'the-dl-element', '{the-dt-element, the-dd-element}', '{}');
-- After <code><a href="#the-dt-element">dt</a></code> or <code><a href="#the-dd-element">dd</a></code> elements inside <code><a href="#the-dl-element">dl</a></code> elements.
...
-- Where <a href="#flow-content-1">flow content</a> is expected.
INSERT INTO element_context_between (elt_name, ecb_parent, ecb_before, ecb_after) VALUES ('the-dt-element', 'the-dl-element', '{}', '{the-dd-element, the-dt-element}');
-- Before <code><a href="#the-dd-element">dd</a></code> or <code><a href="#the-dt-element">dt</a></code> elements inside <code><a href="#the-dl-element">dl</a></code> elements.
...
INSERT INTO element_context_child_no_attr (elt_name, cna_parent, att_name) VALUES ('the-template-element', 'the-colgroup-element', 'attr-colgroup-span');
-- As a child of a <code><a href="#the-colgroup-element">colgroup</a></code> element that doesn't have a <code data-anolis-xref="attr-colgroup-span"><a href="#attr-colgroup-span">span</a></code> attribute.
